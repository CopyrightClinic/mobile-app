...
class Responsive {
  ...
  static double d(double designUnit) => min(_scaleWidth(designUnit), _scaleHeight(designUnit));
  static double r(double designUnit) => d(designUnit) / 2;

  static double f(double designFontSize, {double widthBreakpoint = 600.0, double heightBreakpoint = 900.0}) {
    ...
    final designDiagonal = sqrt(designWidth * designWidth + designHeight * designHeight);
    final deviceDiagonal = sqrt(cappedWidth * cappedWidth + cappedHeight * cappedHeight);
