...
class AppLocalizationData {
  static List<LocalizationModel> get localizations {
    return [LocalizationModel(locale: const Locale('en', 'US'), name: AppStrings.english)];
  }
  ...
  static LocalizationModel getLocalizationByLocale(Locale locale) {
    return localizations.firstWhere(
      (l) => l.locale.languageCode == locale.languageCode && l.locale.countryCode == locale.countryCode,
      orElse: () => defaultLocalization,
    );
  }
}
